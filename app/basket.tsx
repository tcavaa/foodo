    ...
    <>
        ...
        {order && (
            <View style={{ marginTop: '50%', padding: 20, alignItems: 'center'}}>
                <Text style={{ fontSize: 24, fontWeight: 'bold', textAlign: 'center'}}>Thank you for the order</Text>
                <Link href={'/'} asChild>
                    ...
                    ListFooterComponent={
                        <View>
                            ...
                            <View style={styles.totalRow}>
                                ...
                                <Text style={{ fontSize: 18}}>${FEES.services}</Text>
                            </View>
                            <View style={styles.totalRow}>
                            ...
                            <View style={styles.totalRow}>
                                ...
                                <Text style={{ fontSize: 18, fontWeight: 'bold'}}>${(total + FEES.services +FEES.delivery).toFixed(2)}</Text>
                            </View>
                        </View>
                    }
                />
